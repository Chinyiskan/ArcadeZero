<script lang="ts">
  ...
  // sola cuando hay salida. La tarjeta de error amigable (§7) vive en
  // ErrorCard.svelte, montada por +page.svelte justo encima de este panel
  // cuando llega un evento `run_error` (las lineas ##ARCADEZERO## ya no
  // llegan aca como run_stderr, se interceptan en Rust).
